...
public class Main {
    ...
    public static void fillCardsArray(Card[] cards){
        cards[0] = new Card("You spend your money to go on a beautiful trip to sub-Saharan Africa and see the wildlife there",-450);
        cards[1] = new Card("A fox broke in and killed some of your prized chickens last night :(",-300);
        cards[2] = new Card("Deforestation in the Amazon Rainforest has destroyed many habitats, you use funds to set up a conservation scheme",-450);
